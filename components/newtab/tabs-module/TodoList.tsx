						...
						<div className="flex flex-row w-full gap-1">
							...
							>
								<DialogTrigger
									...
									className="h-[36px] hover:bg-slate-100 text-slate-400 hover:text-slate-400 dark:hover:text-slate-400 dark:bg-slate-700 border border-transparent flex items-center justify-center py-2 px-3 rounded hover:cursor-pointer dark:hover:bg-slate-600"
								>
