...
export const HyperlinkSchema = z.object({
	title: z.string().min(1, chrome.i18n.getMessage("min_1_character", "Min 1 character")),
	url: z.string().min(1, chrome.i18n.getMessage("min_1_character", "Min 1 character")),
	description: z.string().min(1, chrome.i18n.getMessage("min_1_character", "Min 1 character"))
});
