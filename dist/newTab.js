...
const ActionButton = () => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: "absolute right-12 bottom-12 text-white", onClick: openSidepanel },
...
const NavBar = () => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("nav", { className: "w-full flex justify-between" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_DigitalClock__WEBPACK_IMPORTED_MODULE_1__["default"], { label: "Uhr", classes: "text-white text-lg p-3", currentTimeStyle: "short" }),
...
const StopWatch = () => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "flex justify-center p-2" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: "text-lg mr-2 text-white hover:text-slate-300", onClick: reset },
            hours,
            ":",
...
const NewTab = () => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "App h-screen" },
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_react-dom_client_js","vendors-node_modules_react-router-dom_dist_index_js","vendors-node_modules_css-loader_dist_runtime_api_js-node_modules_css-loader_dist_runtime_sour-c09256","src_assets_css_tailwind_css"], () => (__webpack_require__("./src/newTab/index.tsx")))
