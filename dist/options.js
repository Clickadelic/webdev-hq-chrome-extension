...
function Checkbox() {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "grid grid-cols-7 justify-between p-4" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "col-span-6" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: "text-base" }, "Do you want to save the settings?")),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "col-span-1 flex items-center mr-4 mb-2" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", { type: "checkbox", id: "yes", name: "confirmation", value: "yes", className: "opacity-0 absolute h-6 w-6" }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "bg-white border-2 rounded-md border-blue-400 w-6 h-6 flex flex-shrink-0 justify-center items-center mr-2 focus-within:border-blue-500" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", { className: "fill-current hidden w-2 h-2 text-blue-600 pointer-events-none", version: "1.1", viewBox: "0 0 17 12", xmlns: "http://www.w3.org/2000/svg" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("label", { htmlFor: "yes", className: "select-none text-base" }, "Yes"))));
}
...
/* harmony import */ var _Checkbox__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Checkbox */ "./src/options/Checkbox.tsx");
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_css-loader_dist_runtime_api_js-node_modules_css-loader_dist_runtime_getU-88f9d9","src_assets_css_tailwind_css"], () => (__webpack_require__("./src/options/options.tsx")))
