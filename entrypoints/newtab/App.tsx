...
const App = () => {
	return (
		<ThemeProvider>
			<BackgroundImage>
				<AppIcon url={`${import.meta.env.WXT_HOMEPAGE_URL}`} classNames="absolute top-4 left-4 z-50" target="_blank" />
				<Clock classNames="mt-4 mx-auto gap-3" digitStyle="text-4xl font-light text-white text-shadow-lg dark:text-slate-300 dark:text-shadow-slate-300" />
