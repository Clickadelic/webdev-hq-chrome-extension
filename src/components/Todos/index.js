...
function TodoList() {
    ...
    return (React.createElement("div", { className: "todo-app m-auto md:w-[760px] justify-between rounded bg-white/10 backdrop backdrop-blur p-2" },
        ...
        React.createElement("ul", { className: "todo-list" },
            ...
            todos.map((todo, index) => (React.createElement("li", { key: index, className: "flex justify-between  mb-2" },
                React.createElement("span", { className: "block w-100 bg-white p-2 rounded-full mr-2" }, todo),
                React.createElement("button", { className: "backdrop-blur-md bg-red-500 text-white rounded p-3 hover:bg-red-600", onClick: () => handleDelete(index) },
