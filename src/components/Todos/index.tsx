    ...
    <div className="todo-app m-auto md:w-[760px] justify-between rounded bg-white/10 backdrop backdrop-blur p-2">
      <form className="bg-white-10 rounded flex justify-between">
        <input
          ...
          className="p-2 pl-3 text-base rounded w-full mr-2"
          placeholder={chrome.i18n.getMessage("newTodo")}
        />
        <span className="inline-flex justify-between">
          <button
            onClick={handleSubmit}
            className="bg-blue-600 text-white rounded p-3 hover:bg-blue-500"
          >
            <svg
      ...
      <ul className="todo-list">
        ...
        {todos.map((todo, index) => (
          <li key={index} className="flex justify-between mt-2">
            ...
            <button
              className="bg-red-500 text-white rounded p-3 max-h-[45px] hover:bg-red-600"
