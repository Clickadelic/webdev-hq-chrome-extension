...
function FormSearchBar() {
  ...
  return (
    <div className="container-md bg-white/30 backdrop-blur p-2 rounded-md">
      <form
        method="GET"
        className="flex w-full bg-white p-2 rounded-md"
        action={engine}
        id="multi-search"
      >
        <input
          type="text"
          className="w-full text-2xl pl-3 focus-visible:outline-0"
          name="q"
          id="q"
        ...
        <button
          className="px-5 ml-3 rounded-md bg-blue-500 hover:bg-blue-600 text-white"
          type="submit"
        >
          <svg
