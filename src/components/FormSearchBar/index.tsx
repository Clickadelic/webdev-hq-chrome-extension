...
function FormSearchBar() {
	...
	return (
		<form method="GET" className="flex justify-between" action={engine} id="multi-search">
			...
			<select onChange={(e) => {handleChange(e)}} value={engine} name="search-engine" id="search-engine" className="p-3 text-2xl text-slate-400">
			...
			<button className="px-5 ml-3 rounded-md bg-blue-500 hover:bg-sky-600 text-white" type="submit">
