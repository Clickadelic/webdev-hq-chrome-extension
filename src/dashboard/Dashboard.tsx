        ...
        <aside className="App-sidebar hidden fixed md:block top-0 left-0 w-64 min-h-screen bg-white border-r">
          <div className="App-sidebar-logo hidden md:flex justify-center px-2 py-3">
            <h1>
              <a
                href="/"
                className="flex justify-between mt-2 text-slate-900 hover:opacity-75"
              >
                <img
                  src="../public/Dashboard.svg"
                  className="logo inline mr-2 -mt-1 h-8 w-8"
                  alt="Tailwind Dashboard"
                />
                <span>
          ...
          <section className="sidebar-section mt-10 mb-6">
            <span className="text-slate-500 text-sm inline-block ml-4 mb-2">
              Dashboard
            </span>
            <ul className="sidebar-nav mb-2">
              <li>
                <a
                  href="/"
                  className="flex justify-between px-4 py-2 bg-sky-100 border-r-2 border-r-sky-500"
                >
                  <span className="flex">
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="bi bi-speedometer2 mt-1 mr-2"
                      viewBox="0 0 16 16"
                    >
                ...
                <ul className="mb-0 ml-0">
                  <li>
                    <a
                      className="block text-slate-600 hover:bg-slate-50 hover:border-r-2 py-1.5 pl-10"
                      href="/"
                    >
                      Default
                    </a>
                ...
                >
                  <span className="flex">
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="bi bi-buildings mt-1 mr-2"
                      viewBox="0 0 16 16"
                    >
                ...
                >
                  <span className="flex">
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="bi bi-signpost-split mt-1 mr-2"
                      viewBox="0 0 16 16"
                    >
          ...
          <div className="absolute block left-0 bottom-0 w-100 p-1 bg-slate-200">
            <img
              ...
              className="w-12 h-12 m-2 ml-4 rounded-full border border-gray-200"
              alt="User Avatar"
            />
          ...
          <nav className="flex justify-between w-max">
            <span className="p-0">
              <a href="/" className="border rounded w-8 h-8 p-2 md:hidden">
                <img
                  src="../public/Dashboard.svg"
                  className="logo w-6 h-6 inline -mt-1"
                  alt="Tailwind Dashboard"
                />
              ...
              <button
                className="hidden md:inline hover:bg-slate-100 ml-3 mr-1 rounded p-2 pt-1"
              ...
              <input
                type="search"
                name="search"
                className="search-input-mobile md:hidden p-2 border rounded-md ml-3 mt-1"
                placeholder="Search"
              />
              <input
                type="search"
                name="search"
                className="search-input-desktop hidden md:inline p-2 border rounded-md ml-3 mt-1"
              ...
              <li>
                ...
                <div className="grid grid-cols-3 hidden w-860 h-72 rounded-md overflow-hidden top-12 right-12 bg-white shadow-md border">
                  <div className="gradient bg-waves p-8 flex flex-col">
                    ...
                    <a className="text-slate-600 bg-slate-50 p-2 mt-5 rounded-md">
                      View
                    </a>
                  </div>
                  <div className="p-8">
              ...
              <li>
                <button className="hover:bg-slate-100 mx-2 inline-flex p-2 rounded">
                  <svg
                    ...
                    height="16"
                    fill="currentColor"
                    className="bi bi-person-circle mt-1 mr-2"
                    viewBox="0 0 16 16"
                  >
        ...
        <div className="pt-16 pl-4 pr-4 md:pl-72 md:pt-24 md:w-full min-h-screen">
          ...
          <main className="md:w-full">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <div className="bg-white rounded-lg pb-2 mb-3 border border-slate-200 overflow-hidden">
                <h2 className="font-medium w-100 p-3 mb-2 bg-fuchsia-200">
                  Box
                </h2>
                <p className="mx-3">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
