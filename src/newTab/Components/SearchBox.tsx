	...
	return (
		<div className="searchbox flex md:w-[800px] m-auto mt-12 mb-48 justify-center p-4 rounded bg-white/40 backdrop backdrop-blur-0">
			<form method="GET" className="flex md:w-[800px]" action="https://search.brave.com/search" id="action-search">
				...
				<select onChange={handleSearchEngineChange} name="search-engine" id="search-engine" className="p-3 text-2xl">
					<option value="https://search.brave.com/search">Brave</option>
					<option value="https://search.brave.com/search">Google</option>
				</select>
