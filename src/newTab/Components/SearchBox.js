...
function SearchBox() {
    ...
    return (React.createElement("div", { className: "searchbox flex md:w-[800px] m-auto justify-center p-4 mb-4 rounded-full bg-white/30 backdrop-blur-md" },
        React.createElement("form", { method: "GET", className: "flex md:w-[800px]", action: engine, id: "action-search" },
            React.createElement("input", { type: "text", className: "p-3 pl-8 text-lg w-full rounded-l-full mx-auto", name: "q", id: "q", placeholder: chrome.i18n.getMessage("search") }),
            ...
            React.createElement("button", { className: "bg-white text-slate-500 hover:text-blue-500 rounded-r-full p-6", type: "submit" },
