...
const NewTab = () => {
	return (
		<div className="App h-screen bg-sky-600">
			...
			<div className="flex m-auto mb-4 md:w-[760px] justify-center rounded bg-white/10 backdrop backdrop-blur p-2">
					...
					<ul className="flex justify-between">
						<li>
							<Link to="/" className="flex justify-between text-white text-base hover:text-slate-300" target="_self">
								...
								<span>{chrome.i18n.getMessage("Apps")}</span>
							</Link>
						</li>
						<li>
							<Link to="/todos" className="flex justify-between text-white text-base hover:text-slate-300" target="_self">
								...
								<span>{chrome.i18n.getMessage("Todos")}</span>
							</Link>
						</li>
						<li>
							<Link to="/tabs" className="flex justify-between text-white text-base hover:text-slate-300" target="_self">
								<span className="mt-1 mr-2">
								...
								<span>{chrome.i18n.getMessage("Tabs")}</span>
							</Link>
						</li>
						<li>
							<Link to="/history" className="flex justify-between text-white text-base hover:text-slate-300" target="_self">
								<span className="mt-1 mr-2">
						...
						<li>
							<Link to="/downloads" className="flex justify-between text-white text-base hover:text-slate-300" target="_self">
								<span className="mt-1 mr-2">
								...
								<span>{chrome.i18n.getMessage("Downloads")}</span>
							</Link>
						</li>
					</ul>
				</nav>
