...
import FormSearchBar from '../lib/FormSearchBar'
	...
	return (
		<div className="App h-screen bg-slate-900">
			...
			<div className="flex m-auto mb-4 md:w-[600px] justify-center rounded bg-white/10 backdrop backdrop-blur p-2">
				<nav className="w-full p-3">
					<ul className="flex justify-between">
						...
						<li>
							<Link to="/bookmarks" className="flex justify-between text-white text-base hover:text-slate-300" target="_self">
								<span className="mt-1 mr-2">
								...
								<span>
									{chrome.i18n.getMessage("Tabgroups")}
								</span>
							</Link>
						</li>
					</ul>
			...
			<main className="flex justify-between">
				<Routes>
					<Route path="/" element={<ToDo classes="m-auto md:w-[600px] justify-between rounded bg-white/10 backdrop backdrop-blur p-2" />} />
					...
					<Route path="/google-apps" element={<GoogleApps classes="m-auto md:w-[600px] justify-between rounded bg-white/10 backdrop backdrop-blur p-2" />} />
