...
function FormSearchBar() {
    ...
    return (React.createElement("form", { method: "GET", className: "flex justify-between", action: engine, id: "multi-search" },
        ...
        React.createElement("button", { onClick: handleSettingsClick, className: "px-4 ml-3 rounded-md text-slate-400 hover:text-slate-600" },
            React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "22", height: "22", fill: "currentColor", className: "bi bi-gear", viewBox: "0 0 16 16" },
        ...
        React.createElement("button", { className: "px-4 ml-3 rounded-md bg-sky-500 hover:bg-sky-600 text-white", type: "submit" },
