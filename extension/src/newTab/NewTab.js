...
function NewTab() {
    return (React.createElement("div", { className: "App h-screen bg-slate-900 bg-mountain-beach" },
        ...
        React.createElement("div", { className: "flex m-auto md:w-[600px] justify-center rounded bg-white/10 backdrop backdrop-blur p-2" },
            React.createElement("nav", { className: "w-full border-b-[1px] p-3" },
                React.createElement("ul", { className: "flex justify-between" },
                    ...
                    React.createElement("li", null,
                        React.createElement(Link, { to: "/settings", className: "flex justify-between text-white text-base hover:text-slate-300", target: "_self" },
                            ...
                            React.createElement("span", null, "Einstellungen")))))),
        React.createElement("main", { className: "flex justify-between" },
            React.createElement(Routes, null,
                React.createElement(Route, { path: "/", element: React.createElement(History, { classes: "flex m-auto md:w-[600px] justify-center rounded bg-white/10 backdrop backdrop-blur p-2" }) }),
