	...
	return (
		<div className="grid grid-cols-7 justify-between p-4">
			...
			<div className="col-span-1 flex items-center mr-4 mb-2">  
				<input type="checkbox" id="yes" name="confirmation" value="yes" className="opacity-0 absolute h-8 w-8" />  
				...
				<label htmlFor="yes" className="select-none text-2xl">Yes</label>  
			</div>
			<div className="col-span-6 mt-2.5">
				<p className="font-medium">Do you want do save the settings?</p>
			</div> 
		</div>
	)
}
