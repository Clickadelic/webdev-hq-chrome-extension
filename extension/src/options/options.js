...
const Options = (React.createElement("div", { className: "min-h-screen bg-slate-200 " },
    React.createElement("div", { className: "md:w-[800px] m-auto bg-white p-4" },
        ...
        React.createElement("div", { className: "grid grid-cols-7 justify-between p-4" },
            React.createElement("div", { className: "col-span-1 flex items-center mr-4 mb-2" },
                React.createElement("input", { type: "checkbox", id: "yes", name: "confirmation", value: "yes", className: "opacity-0 absolute h-8 w-8" }),
                React.createElement("div", { className: "bg-white border-2 rounded-md border-blue-400 w-8 h-8 flex flex-shrink-0 justify-center items-center mr-2 focus-within:border-blue-500" },
                    React.createElement("svg", { className: "fill-current hidden w-3 h-3 text-blue-600 pointer-events-none", version: "1.1", viewBox: "0 0 17 12", xmlns: "http://www.w3.org/2000/svg" },
                        React.createElement("g", { fill: "none", "fill-rule": "evenodd" },
                            React.createElement("g", { transform: "translate(-9 -11)", fill: "#1F73F1", "fill-rule": "nonzero" },
                ...
                React.createElement("label", { htmlFor: "yes", className: "select-none text-2xl" }, "Yes")),
            React.createElement("div", { className: "col-span-6 mt-2.5" },
                React.createElement("p", { className: "font-medium" }, "Do you want do save the settings?"))),
